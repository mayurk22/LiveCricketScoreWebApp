...
import com.CrickAppp.CricketInformerBackend.Repositories.MatchRepo;
...
public class MatchServiceImpl implements MatchService{
    ...
    public List<Match> getLiveMatches() {
        ...
        try{
            ...
            Elements liveScoreElement=document.select("div.cb-mtch-lst.cb-tms-itm");
            for (Element match : liveScoreElement){
                ...
                String battingTeam = match.select("div.cb-hmscg-tm-nm").text();
                String score=matchBatTeamInfo.select("div.cb-hmscg-tm-nm+div").text();
                Elements bowlTeamInfo = match.select("div.cb-hmscg-bwl-txt");
                String bowlTeam = match.select("div.cb-hmscg-tm-nm").text();
